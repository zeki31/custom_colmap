...
class VisualizerViser(Visualizer[VisualizerViserCfg]):
    def __init__(
        self, cfg: VisualizerViserCfg, logger: wandb.sdk.wandb_run.Run, save_dir: Path
    ):
        self.cfg = cfg
        self.logger = logger
    ...
    def viz(self, base_dir: Path) -> None:
        ...
        cameras = read_cameras_binary(self.save_dir / "sparse" / "0" / "cameras.bin")
        images = read_images_binary(self.save_dir / "sparse" / "0" / "images.bin")
        points3d = read_points3d_binary(self.save_dir / "sparse" / "0" / "points3D.bin")
        ...
        def visualize_frames() -> None:
            """Send all COLMAP elements to viser for visualization. This could be optimized a ton!"""
            ...
            for img_id in tqdm(img_ids):
                ...
                image_filename = base_dir / img.name
                ...
                image = image[:: self.cfg.resize, :: self.cfg.resize]
